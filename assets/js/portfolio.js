(function () {
  const translations = {
    en: {
      ...
      "project.droneDescription": "DroneDream is a local-first PX4 and Gazebo tuning platform that turns control-parameter search into a visual, repeatable engineering workflow. It connects experiment setup, simulation, comparison, and evidence so users can understand each tuning decision, revisit results, and move from trial and error toward confident autonomous-flight development.",
      ...
      "about.intro": "I am an Electrical and Computer Engineering student at Zhejiang University and an exchange student at the University of Illinois Chicago during my junior year. I value collaborative study.",
      ...
      "news.westlake": "I participated in the EIE Summer School at Westlake University, where I explored interdisciplinary topics in electronic and information engineering through lectures, technical discussions, and collaborative learning with students from different academic backgrounds.",
    ...
    zh: {
      ...
      "hero.lead": "我致力于为自主机器、仿真与工程教育构建交互式系统，把复杂的工作流程转化为人们能够看见、测试、理解，并通过直接交互持续改进的工程体验。",
      "hero.explore": "浏览代表项目",
      "hero.ece": "电气与计算机工程",
      "hero.school": "浙大–UIUC",
      "hero.exchange": "交换学生",
      ...
      "journey.next": "下一张照片",
      "project.drag": "拖动旋转",
      "project.droneDescription": "DroneDream 是一个本地优先的 PX4 与 Gazebo 调参平台，将控制参数搜索转化为可视、可重复的工程流程。它连接实验设置、仿真运行、结果对比与证据整理，帮助使用者理解每一次调参决策、回看结果，并从反复试错走向更有把握的自主飞行开发。",
      "project.raceDescription": "RaceCar Lab 是一个交互式方程式赛车工程环境，包含代码生成的 3D 赛车、部件研究、公式、诊断工具与双语学习路径。迈凯伦风格的展示来自我对 McLaren 和 Lando Norris 的支持，而我的女朋友支持 Ferrari 和 Charles Leclerc；这份友好的竞争也让赛车工程探索更具个人色彩。",
      ...
      "about.intro": "我是浙江大学电气与计算机工程专业学生，并在大三学年作为交换生前往伊利诺伊大学芝加哥分校（UIC）学习，也十分重视协作式学习。",
      "about.body": "我的工作始终围绕一个问题展开：如何让技术复杂的系统更易于操作、评估和学习？这个问题将我在自主飞行、人工智能、仿真和交互式工程教育方面的项目连接起来，并让每一项工具都扎根于真实的工程实践。",
      ...
      "news.westlake": "我参加了西湖大学 EIE 暑期学校，并通过专题讲座、技术讨论以及与不同学术背景同学的协作学习，探索了电子与信息工程领域的跨学科主题。",
