(function () {
  const translations = {
    ...
    zh: {
      ...
      "about.intro": "我是浙江大学电气与计算机工程专业的大四本科生。大三学年，我曾作为交换生前往伊利诺伊大学厄巴纳-香槟分校（UIUC）学习一年。目前，我正在 Bruce Yu 老师的课题组开展无人机视角下人体动作识别研究，重点关注如何从空中视频中理解人的行为、动作特征及其时序信息。",
      "about.body": "在此之前，我曾在马涵之老师的课题组完成为期一年的学生科研训练计划（国家级 SRTP）。研究围绕基于机器学习与多目标优化的高速信号通道建模展开，并最终以“优秀”评价结题。大二暑期，我还在曹继兴老师的课题组开展了基于 YOLOv11 的隧道火灾与车辆碰撞检测研究。",
